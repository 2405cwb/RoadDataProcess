...
namespace hd
{
	namespace ptcloud
	{
		hdFilterSelectAll::hdFilterSelectAll()
		{
		}
		...
		//! 过滤处理，更新选中状态
		void hdFilterSelectAll::doFilter(hdVector<PointXYZIPRGBA>* pt_array,
		...
		//! 过滤处理，更新选中状态
		void hdFilterSelectAll::doFilter(CHdParcelBase* pt_array,
			CBursaWolfModel* render_trans, CBursaWolfModel* pcd_trans)
		{

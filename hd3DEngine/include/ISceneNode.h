	...
	*/
	...
	public:
		...
		*/
		...
		//! 设置姿态角度Yaw\Pitch\Roll,根据姿态角计算irr显示角度
		virtual void SetHPR(double yaw,double pitch,double roll)
		{
			core::CMatrix4<double> Mat;
			Mat.SetHPR(yaw,pitch,roll);
			core::vector3d<irr::f64> rotation = Mat.getRotationDegrees();
			setRotation(core::vector3df((f32)rotation.X, (f32)rotation.Y, (f32)rotation.Z));
		}

...
void CNullDriver::setGradientBackground(SColor color/* =SColor */)
{
...
void CNullDriver::draw3DPointList(const void* vertices,u32 vertexCount,void* colorBuf,E_VERTEX_TYPE type)
{
...
//! 绘制三维点-龚书林
void CNullDriver::draw3DPoint(const core::vector3df& pt,SColor color)
{

}
//! 绘制三维点-龚书林
void CNullDriver::draw3DPoint(float x,float y,float z,SColor color)
{

}

void CNullDriver::draw2DPoly( bool &drawSuccess, const core::position2d<f32>* points2d, u32 vertexCount,SColor color/*=SColor(255,255,255,255)*/ )
{
	
}

void CNullDriver::draw2DTriangle(const core::position2d<f32>* points2d, u32 vertexCount,SColor color/* =SColor */)
{

}

void CNullDriver::drawSphere(const core::vector3d<f32> center3d, f32 radius,SColor color/*=SColor(255,255,255,255)*/)
{
	
}

void CNullDriver::drawCircle(const core::vector3d<f32> center3d, f32 radius, const core::vector3d<f32> normal3d, u32 count, SColor color/* = SColor(255,255,255,255)*/)
{
	
}

//! 绘制二维圆形
void CNullDriver::draw2DCircle(const core::position2di src, int radius, SColor color/* = SColor(255,255,255,255)*/)
{
...
void CNullDriver::draw2DEllipse( const core::position2di src,int rx,int ry,SColor color /*= SColor(255,255,255,255)*/ )
{

}

void CNullDriver::draw3DCylinder(const core::vector3d<f32> start,const core::vector3d<f32> end,f32 radius, SColor color /* = SColor */)
{

}


void CNullDriver::draw3DCircle(const core::vector3d<f32> center3d, f32 radius, const core::vector3d<f32> normal3d, u32 count, SColor color /* = SColor */)
{

}

//! 用虚线绘制二维线段
void CNullDriver::draw2dDashedLine(const core::position2d<s32>& start, 
	const core::position2d<s32>& end, SColor color)
{
...
//! 用虚线绘制二维线段(兼容AMD显卡)
void CNullDriver::draw2dDashedLineAMD(const core::position2d<s32>& start, 
    const core::position2d<s32>& end, SColor color)
{
...
//! 用虚线绘制三维线段
void CNullDriver::draw3dDashedLine(const core::vector3df& start,
	const core::vector3df& end, SColor color)
{
...
void CNullDriver::DisplayAxis(core::vector3df center,   // data center
...
void CNullDriver::DisplaySingleAxis(core::vector3df start,  // 起点坐标
	...
	int		iSlices,				                    //  Number of slices around dia
	int		iStacks,				                    //  Number of Stacks about length
	SColor  color,				                    //  X-Axis Color (Use Defaults..)
	bool	bSolid )                                    //  Display as Solid
{
...
// add by chy 2013/8/17 draw Axis
void CNullDriver::DrawCompass(core::vector3df center,   // data center
	double	dAxisLength,						        // Axis length
	double	dAxisRadius,					 	        // Axis diameter
	double	dArrowLength,						        // Arrow length
	double	dArrowRadius,			                    //  Arrow diameter
...
// add by chy 2013/8/17 draw Axis
void CNullDriver::drawFloatLine(core::vector3df center,   // data center
	double	dAxisLength,						        // Axis length
	double	dAxisRadius,					 	        // Axis diameter
	double	dArrowLength,						        // Arrow length
	double	dArrowRadius,			                    //  Arrow diameter
	int		iSlices,				                    //  Number of slices around dia
	int		iStacks,				                    //  Number of Stacks about length
	float	fColorX[4],				                    //  Color (Use Defaults..)
	bool	bSolid )                                    //  Display as Solid
{
...
void CNullDriver::draw3DArc( const core::vector3d<f32> center3d,const core::vector3d<f32> arcStart , const core::vector3d<f32> arcEnd , f32 radius,  f32 fAngle, u32 count ,SColor color /*= SColor(255,255,255,255)*/ )
{

}

// 绘制二维圆弧(圆弧中心点, 起始圆弧射线点，终止圆弧的射线点（射线点不需要在圆上）)-2016.04.07.张阳
void CNullDriver::draw2DArc(const core::vector2di center2d, // 圆弧所在圆的圆心
...
void CNullDriver::draw3DVerticalLine( const core::vector3d<f32> mid3d, /* 垂足点 */ const core::vector3d<f32> start3d, /* 三角形顶点 */ const core::vector3d<f32> end3d, /* 三角形顶点 */ f32 radius, /* 垂足线段长度 */ SColor color /*= SColor(255,255,255,255)*/ )
{

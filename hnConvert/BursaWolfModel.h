...
class HNCONVERT_EXPORT CBursaWolfModel
{
public:
	...
	int invers_matrix(double *m1, int n) const;

	int invers_matrix(float *m1, int n) const;
...
public:
	...
	// 创建自定义坐标系与84坐标系转换模型
	void createTransModel(double dCenterX,double dCenterY,double dCenterZ, double dNormalX,

...
namespace hd
{
	namespace scene
	{
		...
		public:
			...
			// 更新包围盒
			void UpdateBoundingBox(vector<hnPoint3d>& pPartPts);

			// 设置显示部分点云
			bool SetPartPoints(vector<hnPoint3d>& pPartPts);

			// 获得渲染点云，外部调用
			vector<hnPoint3d>& GetPartPoints(){return m_pPartPcd;}

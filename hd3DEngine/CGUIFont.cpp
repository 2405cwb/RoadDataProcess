...
void CGUIFont::SetFontSize(EHD_FONT_SIZE nSize)
{
	// CGUIFont类没有字体大小的接口
}

wchar_t* CGUIFont::CharToWchar(const char* c)
{
	return NULL;
}

bool CGUIFont::IsExistWideChar(const char* str)
{
	return false;
}

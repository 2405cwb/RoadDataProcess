...
void DockAreaTitleBarPrivate::createCustomMenuButton()
{
	...
	QIcon Icon = CDockManager::iconProvider().customIcon(hn::eIcon::DockAreaCustomMenuIcon);
	if (Icon.isNull())
	{
...
void DockAreaTitleBarPrivate::createButtons()
{
	...
	internal::setButtonIcon(TabsMenuButton, QStyle::SP_TitleBarUnshadeButton, hn::DockAreaMenuIcon);
	...
	internal::setButtonIcon(UndockButton, QStyle::SP_TitleBarNormalButton, hn::DockAreaUndockIcon);
	...
	internal::setButtonIcon(CloseButton, QStyle::SP_TitleBarCloseButton, hn::DockAreaCloseIcon);

  ...
  if ((header.version_major == 1) && (header.version_minor >= 4))
  {
    ...
    //        fprintf(stderr,"WARNING: wrong header.evlrs[%d].reserved: %d != 0xAABB\n", i, header.evlrs[i].reserved);
          ...
          if (header.evlrs[i].record_length_after_header)
          {
            ...
            else if (strcmp(header.evlrs[i].user_id, "lastools tile") == 0 || strcmp(header.evlrs[i].user_id, "finalized tile") == 0 || strcmp(header.evlrs[i].user_id, "lastiling tile") == 0)
            {
              header.clean_lastiling();
              header.vlr_lastiling = new LASvlr_lastiling();
              ...
              {
                fprintf(stderr,"ERROR: record_length_after_header of %s EVLR is %d instead of 28\n", header.evlrs[i].user_id, (I32)header.evlrs[i].record_length_after_header);
                return FALSE;
              }
            }
            else
          ...
          else if (strcmp(header.evlrs[i].user_id, "laszip encoded") == 0 || strcmp(header.evlrs[i].user_id, "lastools tile") == 0 || strcmp(header.evlrs[i].user_id, "finalized tile") == 0 || strcmp(header.evlrs[i].user_id, "lastiling tile") == 0)
          {

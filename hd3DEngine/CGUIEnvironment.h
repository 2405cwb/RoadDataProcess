...
public:
	...
	//! returns default ttfont
	virtual IGUIFont* getBuiltDefaultFont() const;

	//! returns Chinese ttfont
	virtual IGUIFont* getBuiltChineseFont() const;
...
private:
	...
	// 加载默认字体(英文),取代上面的loadBuiltInFont()接口
	void loadBuiltDefaultFont();

	// 加载中文字体
	void loadBuiltChineseFont();

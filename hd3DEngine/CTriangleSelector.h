...
public:
	...
	//! Constructs a selector based on a mesh,add by gsl 2012/07/12
	CTriangleSelector(const IMeshBuffer* meshBuf, const ISceneNode* node);
...
protected:
	...
	//! Create from a mesh
	virtual void createFromMesh(const IMeshBuffer* meshBuf); 

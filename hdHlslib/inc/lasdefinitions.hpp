...
===============================================================================
  ...
  COPYRIGHT:
    ...
    (c) 2005-2012, Martin Isenburg, LASSO - rapid tools to catch reality
...
#define LAS_TOOLS_VERSION 120506
...
#define LAS_TOOLS_FORMAT_ASC     6
#define LAS_TOOLS_FORMAT_BIL     7
#define LAS_TOOLS_FORMAT_FLT     8
#define LAS_TOOLS_FORMAT_TXT     9

class HLS_API LASwavepacket
{
public:
  LASwavepacket() {zero();};
...
public:
	...
	LASPointStru(const LASpoint & other)
	{
		*this = other;
	}

	LASPointStru & operator=(const LASpoint & other)
	{
		x = other.x;
		y = other.y;
		z = other.z;
...
//! Las文件头信息-龚书林
class HLS_API LASInfo
{
public:
	LASInfo()
	{
		memset((void*)this, 0, sizeof(LASInfo));
	}
...
class HLS_API LASheader : public LASquantizer, public LASattributer
{
public:
  CHAR file_signature[4];
  U16 file_source_id;

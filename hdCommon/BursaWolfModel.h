...
namespace hd
{
	class HDCOMMON_API CBursaWolfModel
	{
	public:
	...
	//private:
		...
		// 通过同名平面的法向量计算旋转角度初值 [zfei 2014/10/10]
		bool CreateRotateMatByPlanes(std::vector<NormalPointXYZ>& srcPlanes, std::vector<NormalPointXYZ>& destPlanes);

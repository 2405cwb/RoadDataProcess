...
void DockManagerPrivate::loadStylesheet()
{
	...
	//QFile StyleSheetFile("D:/06-tfsSource/01-HnGrabClientSrc/HnGrabClientSrc/QtAdvancedDocking/stylesheets/default.css");
#endif
	bool isOpened = StyleSheetFile.open(QIODevice::ReadOnly);
	...
	CDockWidget* Dockwidget)
{
	...
	if (AreaWidget)
	{
		return addDockWidget(hn::CenterDockWidgetArea, Dockwidget, AreaWidget);
	}
...
{
	return addDockWidget(hn::CenterDockWidgetArea, Dockwidget, DockAreaWidget);
}

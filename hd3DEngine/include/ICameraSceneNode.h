	...
	*/
	...
	public:
		...
		*/
		...
		virtual void setProjectionType(u32 type) = 0;

		virtual void setWidthofViewVolume(f32 width) = 0;

		virtual f32 getWidthofViewVolume() = 0;

		virtual void setHeightofViewVolume(f32 height) = 0;

		virtual f32 getHeightofViewVolume() = 0;
		...
		//! chy 2013/8/23 add. Calculate the distance between the pos and target.
		virtual void CalculateFocalLength() = 0;
    	//! chy 2013/8/23 add. Get the distance between the pos and target.
		virtual double GetFocalLength()= 0;
		//! chy 2013/8/23 add. Get rotation by target.
		virtual void GetRotationAboutTarget(f32& x,f32& y, f32& z)= 0;
		//! chy 2013/8/23 add .Set rotation to target.
		virtual void SetRotationAboutTarget(f32 x, f32 y, f32 z)= 0;

...
//Begin: Added by yaoli on 2012/5/21 for customized animator
...
ISceneNodeAnimator* CDefaultSceneNodeAnimatorFactory::createSceneNodeAnimator(ESCENE_NODE_ANIMATOR_TYPE type, ISceneNode* target)
{
	...
	case ESNAT_CAMERA_MAYA:
		...
		break;
	//Added by yaoli on 2012/5/21 for customized animator;
	case ESNAT_CAMERA_CUS:
		anim = new CSceneNodeAnimatorCameraCus(CursorControl);
		break;
	default:
		break;
	}

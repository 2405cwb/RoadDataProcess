...
public:
	...
	*disType:病害绘制类型
	*/
	bool outDiseaseDxf( const char* filePath , std::vector<hnCommon::hn3dDiseaseDef<hnCommon::hn3dPointD>*> diss,int disType);
	//设计模式病害
	bool outDiseaseLineDxf(const char* filePath, std::vector<hnCommon::hn3dDiseaseLineDef<hnCommon::hn3dPointD>*> diss, int disType);
	private:
		// 初始化CAD 做一些必要准备工作

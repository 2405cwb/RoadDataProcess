...
public:
	...
	//主接口
	bool outDisease(const char*outDir,vector<Disease_C>& vecDisease,hnGridDiseaseInfo grid,int direction,int roadType,void (*processCallback)(float, const char*) = NULL);

	//C#病害转C++病害
	bool calDiseaseAttr(vector<Disease_C>& vecDisease,int roadType);

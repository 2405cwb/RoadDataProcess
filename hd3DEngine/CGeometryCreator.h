...
class IRRLICHT_API CGeometryCreator : public IGeometryCreator
{
...
public:
	...
	//Add Color [add by mzm 2013.10.17]
	IMesh* createSphereMesh(f32 radius, u32 polyCountX, u32 polyCountY, video::SColor sclr) const;
	...
	//»æÖÆ¶þÎ¬Æ½°å [add by mzm 2013.10.18]
	IMesh* createPlanMesh(const core::vector3df& size,video::SColor sclr) const;
};

...
namespace gui
{
// 字体大小设置 [2014/4/9 zhangfei]
typedef enum EHD_FONT_SIZE
{
	SIZE_FONT_SMALL_1  =6,
	SIZE_FONT_SMALL_2  =7,
	SIZE_FONT_SMALL_3  =8,
	...
	SIZE_FONT_NORMAL_1 =12,
	SIZE_FONT_NORMAL_2 =13,
	SIZE_FONT_NORMAL_3 =14,
	SIZE_FONT_NORMAL_4 =15,

	SIZE_FONT_NORMAL_5 =18,
...
public:
	...
	*/
	...
	// 设置字体大小
	virtual void SetFontSize(EHD_FONT_SIZE nSize) = 0;

	// 宽字节到单字节的转换
	virtual wchar_t* CharToWchar(const char* c) = 0;

	// 判断字符串中是否包含中文字符
	virtual bool IsExistWideChar(const char* str) = 0;

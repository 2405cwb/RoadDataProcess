...
namespace hd
{
	...
	*/
	...
	public:
		...
		void rotateXZBy(f64 degrees, const CHdVector3d<T>& center=CHdVector3d<T>())
		{
			degrees *= DEGTORAD64;
			f64 cs = cos(degrees);
			f64 sn = sin(degrees);
		...
		\param center: The center of the rotation. */
		void rotateXYBy(f64 degrees, const CHdVector3d<T>& center=CHdVector3d<T>())
		{
			degrees *= DEGTORAD64;
			f64 cs = cos(degrees);
			f64 sn = sin(degrees);
		...
		\param center: The center of the rotation. */
		void rotateYZBy(f64 degrees, const CHdVector3d<T>& center=CHdVector3d<T>())
		{
			degrees *= DEGTORAD64;
			f64 cs = cos(degrees);
			f64 sn = sin(degrees);
		...
		void rotateByVector(f64 degrees, CHdVector3d<T> axe)
		{
		...
		CHdVector3d<T> getInterpolated(const CHdVector3d<T>& other, f64 d) const
		{
			const f64 inv = 1.0 - d;
		...
		\return An interpolated vector. This vector is not modified. */
		CHdVector3d<T> getInterpolated_quadratic(const CHdVector3d<T>& v2, const CHdVector3d<T>& v3, f64 d) const
		{
		...
		Note that this is the opposite direction of interpolation to getInterpolated_quadratic()
		*/
		CHdVector3d<T>& interpolate(const CHdVector3d<T>& a, const CHdVector3d<T>& b, f64 d)
		{
	...
	template <>
	inline CHdVector3d<s32> CHdVector3d<s32>::operator /(s32 val) const {return CHdVector3d<s32>(X/val,Y/val,Z/val);}
	template <>
	inline CHdVector3d<s32>& CHdVector3d<s32>::operator /=(s32 val) {X/=val;Y/=val;Z/=val; return *this;}



	//! Typedef for a f32 3d vector.
	typedef CHdVector3d<f32> CHdVector3df;

	typedef CHdVector3d<f64> CHdVector3dd;

	//! Typedef for an integer 3d vector.
	typedef CHdVector3d<s32> CHdVector3di;
